...
import vinoteka.bp.BPFacadeAdmin
import vinoteka.bp.BPFacadeAdminImpl
...
class Admin constructor(id: EntityID<Int>) : IntEntity(id), ModelWithUser {
    ...
    companion object : IntEntityClass<Admin>(AdminTable), BPFacadeAdmin by BPFacadeAdminImpl
}